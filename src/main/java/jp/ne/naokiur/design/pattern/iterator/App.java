...
public class App {
    ...
    public static void main(String[] args) {
        List<Employee> targetEmployees = Arrays.asList(new Employee("john", "John", "Smith", 24), new Employee("jane", "Jane", "Smith", 22), new Employee("bob", "Bob", "Smith", 22));
        ...
        List<Employee> employees = targetEmployees;
        ...
        EmployeeMember employeeMember = new EmployeeMember(targetEmployees);
